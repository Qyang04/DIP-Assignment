...
if __name__ == "__main__":
    input_video_list = [
    ("office.mp4", "office_processed.avi"),
    ("alley.mp4", "alley_processed.avi"),
    ("singapore.mp4", "singapore_processed.avi"),
    ("traffic.mp4", "traffic_processed.avi")
    ]
    output_video_list = [
    ("office_processed.avi"),
    ("alley_processed.avi"),
    ("singapore_processed.avi"),
    ("traffic_processed.avi")
    ]
    ...
    for input_video, output_video in zip(input_video_list, output_video_list):
